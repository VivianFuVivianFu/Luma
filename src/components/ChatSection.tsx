      ...
      <div className="p-6 border-t border-gray-200/50 bg-gradient-to-r from-gray-50/80 to-blue-50/80">
        <div className="flex items-center gap-4">
          <input
            ...
            className="flex-1 bg-white border border-gray-300 rounded-full px-6 py-3 text-gray-700 outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-transparent shadow-sm placeholder-gray-500"
            disabled={isLoading}
          />
          <button
            type="button"
            onClick={sendMessage}
            disabled={!canSend}
            className="inline-flex items-center justify-center rounded-full bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white p-3 disabled:opacity-50 disabled:cursor-not-allowed shadow-md transition-all duration-200 hover:scale-105"
            title="Send message"
          >
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white shadow-md transition-all duration-200 hover:scale-105 p-3"
            title="Start voice call"
          >
            <Phone className="w-4 h-4" />
            <span className="text-xs font-medium" style={{fontFamily: 'Gowun Dodum, sans-serif'}}>Voice</span>
          </button>
        </div>
      </div>
